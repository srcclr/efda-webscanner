...
class Home extends React.Component {
    ...
    render() {
        return (
            ...
            <h1 className="head">Project Scanning </h1>
            <br />
            <div className="step1">
            <h3 className="chooseProject"> Step 1: Choose Project </h3>
            <p> Choose projects from EFDA  </p>
            <hr></hr>
            <h4> <u>EFDA Projects </u></h4>{/*EFDA projects */}
            <Row>
                <Col md={3} mdPush={3}>
                    <h5 className="title"> 1) Java </h5>
                ...
                <Col md={3} mdPush={3}>
                    <h5 className="title"> 2) Python </h5>
                ...
                <Col md={3} mdPush={3}>
                    <h5 className="title"> 3) Javascript </h5>
            ...
            <Row>
                <Col md={3} mdPush={3}>
                    <h5 className="title"> 5) Objective-C </h5>
                ...
                <Col md={3} mdPush={3}>
                    <h5 className="title"> 7) Golang </h5>
            ...
            <br/>
            <div className="step2">
                <h3 className="startScan"> Step 2: Start Scanning! </h3>
